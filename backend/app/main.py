...
from app.api.routes.balance_projection import router as balance_projection_router
...
app.include_router(balance_projection_router)
...
def root() -> dict:
    return {
        ...
        "phase": "Fase 7 - Balance proyectado simplificado",
        "docs": "/docs",
    }
